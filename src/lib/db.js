...
export async function loadDomains(userId): Promise<Domain[]> {
  if (!supabase) return []
...
export async function loadGoals(userId): Promise<Goal[]> {
  if (!supabase) return []
  const { data } = await supabase
    .from('goals')
    .select('*')
...
export async function loadTasks(userId): Promise<Task[]> {
  if (!supabase) return []
  const { data } = await supabase
    .from('tasks')
    .select('*')
...
export async function deleteTasksByChallenge(challengeActiveId) {
  if (!supabase) return
...
export async function loadCustomChallenges(userId): Promise<Challenge[]> {
  if (!supabase) return []
  const { data } = await supabase
...
export async function deleteGoalsByDomain(domainId) {
  if (!supabase) return
...
export async function loadActiveChallenges(userId): Promise<ActiveChallenge[]> {
  if (!supabase) return []
  const { data } = await supabase
...
export async function loadDomainsSince(userId, since): Promise<Domain[]> {
  if (!supabase) return []
  const { data } = await supabase
    .from('domains')
    .select('*')
...
export async function loadGoalsSince(userId, since): Promise<Goal[]> {
  if (!supabase) return []
  const { data } = await supabase
    .from('goals')
    .select('*')
...
export async function loadTasksSince(userId, since): Promise<Task[]> {
  if (!supabase) return []
  const { data } = await supabase
    .from('tasks')
    .select('*')
...
export async function loadCustomChallengesSince(userId, since): Promise<Challenge[]> {
  if (!supabase) return []
  const { data } = await supabase
    .from('custom_challenges')
    .select('*')
...
export async function loadActiveChallengesSince(userId, since): Promise<ActiveChallenge[]> {
  if (!supabase) return []
  const { data } = await supabase
    .from('active_challenges')
    .select('*')
...
export async function loadRecurringTemplates(userId) {
  if (!supabase) return []
  const { data } = await supabase
...
export async function insertRecurringTemplate(userId, t) {
  if (!supabase) return null
...
export async function updateRecurringTemplateInDb(id, data) {
  if (!supabase) return
  const patch = {}
...
export async function deleteRecurringTemplateFromDb(id) {
  if (!supabase) return
