...
import { Trophy, Zap, CheckCircle2, Plus, Pencil, Trash2 } from 'lucide-react'

export default function ChallengesPage() {
  const { activeChallenges, getChallengeProgress, stopChallenge, customChallenges, deleteCustomChallenge } = useStore()
  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl mx-auto page-enter">
      ...
      <div className="flex items-start justify-between gap-4 mb-6">
        <PageHeader
          title="Challenges"
          subtitle="Lance-toi des défis sur X jours. Les tâches se génèrent automatiquement."
        />
        <button
