...
export default function ChallengesPage() {
  ...
  const [editingChallenge,  setEditingChallenge]  = useState(undefined)
  const [showCreateModal,   setShowCreateModal]   = useState(false)
  const [confirmCatalogue,  setConfirmCatalogue]  = useState(null)
  const [confirmCustom,     setConfirmCustom]     = useState(null)
  ...
  const handleDeleteCatalogue = (id) => setConfirmCatalogue(id)
  ...
  const handleDeleteCustom = (id) => setConfirmCustom(id)
