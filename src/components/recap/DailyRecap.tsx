...
function RecapStat({ icon, label, value, color }: { icon: React.ReactNode; label: string; value: string | number; color: string }) {
  return (
...
export function DailyRecap() {
  ...
  const msg = isPerfect
    ...
    : todayPct > 0   ? { emoji: '🌱', text: 'Tu as avancé. Chaque tâche compte.' }
